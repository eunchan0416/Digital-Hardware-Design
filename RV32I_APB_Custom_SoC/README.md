...
| APB_GPIO | 0x2200_2000 | 16B | R/W | Bidirectional I/O Control |
...
* Compiled C/Assembly firmware binaries (`.mem`) are loaded into the instruction memory (`sw/` directory).
* The RV32I core fetches instructions, executes them, and performs bus transactions to peripheral addresses.
* Protocol compliance and functional correctness (e.g., UART Baud Rate generation, APB SETUP/ACCESS state transitions) are verified via Vivado Simulator.

![Simulation Waveform](./docs/sim_waveform_uart.png)
